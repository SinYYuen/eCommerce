...
const displayProductAPI = 'https://sinyuenecommerce.azurewebsites.net/eScriptCoder/allProduct';
const findProductAPI = 'https://sinyuenecommerce.azurewebsites.net/eScriptCoder/';
